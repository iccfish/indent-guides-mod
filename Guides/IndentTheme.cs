...
namespace IndentGuide
{
	...
	public class LineBehavior : IEquatable<LineBehavior>
	{
		...
		/// <summary>
		/// True to disable indent guide on this content type.
		/// </summary>
		[ResourceDisplayName("VisibleDisabledName")]
		[ResourceDescription("VisibleDisabledDesc")]
		[SortOrder(0)]
		...
		internal void Load(RegistryKey key)
		{
			...
			Disabled = (int)key.GetValue("Disabled", 0) != 0;
		}
		...
		internal void Save(RegistryKey key)
		{
			...
			key.SetValue("Disabled", Disabled ? 1 : 0);
		}
